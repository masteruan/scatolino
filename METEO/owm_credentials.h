...
const char* ssid     = "INSERISCI QUI L'SSD DEL TUO WIFI";
const char* password = "INSERISCI QUI LA PASSWORD DEL TUO WIFI";

// Use your own API key by signing up for a free developer account at https://openweathermap.org/
String apikey       = "INSERISCI QUI LA API KEY DEL TUO ACCOUN OPENWEATHER";                      // See: https://openweathermap.org/
...
String LAT              = "45.58";                         // Home location Latitude
String LON              = "9.27";                          // Home location Longitude

String City             = "MONZA";                         // Your home city See: http://bulk.openweathermap.org/sample/
...
String Language         = "IT";                            // NOTE: Only the weather description is translated by OWM
