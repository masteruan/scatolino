...
String apikey       = "Xxxxx";                      // See: https://openweathermap.org/
...
//45.4931295,9.1552303
String LAT              = "40.40";                         // Home location Latitude
String LON              = "10.10";                          // Home location Longitude

String City             = "ROME";                         // Your home city See: http://bulk.openweathermap.org/sample/
